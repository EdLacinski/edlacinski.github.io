export const creatorPlatforms = [
  {
    ...
    profileImage: 'https://yt3.googleusercontent.com/ytc/AIdro_ndV5A_5NDZBIdzF6VyZNRVWmLHRp2fJT-j3WYFzzxaqQ=s240-c-k-c0x00ffffff-no-rj',
    description: 'The main Eclipse Ed home for TCG coverage, community spotlights, interviews, and creator-led event stories.',
    stats: [
      { value: '218', label: 'Subscribers' },
      { value: '29,825', label: 'Total views' },
      { value: '134', label: 'Videos' },
    ],
  ...
  },
  {
    ...
    profileImage: 'https://yt3.googleusercontent.com/OANVfh6swYwYlxNe3wK3F2NDUlsivd3x1vLKqCUxfvRxHUczeTUXS5ZgtvL1HGqNYaphMjAUTQ=s240-c-k-c0x00ffffff-no-rj',
    ...
    stats: [
      { value: '11', label: 'Subscribers' },
      { value: '146', label: 'Total views' },
      { value: '35', label: 'Videos' },
    ],
    updated: 'June 20, 2026',
    latestVideo: {
      id: 'X5EYubJMfHY',
  ...
  },
  {
    ...
    profileImage: 'https://static-cdn.jtvnw.net/jtv_user_pictures/74afdf1c-6ca7-4d35-9ab2-d5ab164e526c-profile_image-300x300.png',
  ...
  },
  {
    ...
    profileImage: 'https://pbs.twimg.com/profile_images/1668651037207543810/rgGezHFC_400x400.jpg',
