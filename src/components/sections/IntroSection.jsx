  ...
  return (
    <section className="intro section-shell" aria-labelledby="intro-title">
      ...
      <div>
        ...
        <p>My work has taken me from school technology and state reporting to high-traffic theater operations and creator events. The thread connecting it all is simple: listen closely, make the complicated feel manageable, and leave people better supported than I found them.</p>
      </div>
    </section>
  )
}
